...
TableCardProps<TData>) => {
    ...
    return (
        <>
            <table
                className={cn(
                    'table-card-collapsible p-3 bg-tertiary-50 rounded-lg text-gray-400 border-separate space-y-6 text-sm w-full',
                    isLoading && 'opacity-40'
                )}
            >
                <TableCardHeader table={table} />
                <TableCardBody table={table} meta={meta} subComponent={subComponent} />
            </table>
