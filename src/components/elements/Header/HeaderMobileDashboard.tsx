...
const HeaderMobileDashboard = ({ minimize, setMinimize }: HeaderDashboardProps) => {
    ...
    return (
        <header className="z-header shadow-sm rounded-md z-20 bg-white w-full left-0 top-0 px-2 py-2 font-primary h-[65px] flex items-center justify-center ">
            <div className="max-w-[100%] flex w-full items-center justify-between mx-auto px-1">
                {/* Logo */}
                <div className="space-x-2 items-center hidden md:flex gap-1">
                    ...
                    <div className="flex flex-col gap-0 pr-0 border-l border-tertiary-200">
                        <div className="pl-3">
                            <p className="text-tertiary-800 text-[15px] font-bold">{pageIdentity?.title}</p>
                            <Breadcrumb
                                items={
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                alt={user?.full_name}
                            />
                            <div className="flex flex-col w-auto max-w-[100px] text-left text-tertiary-800 caption-large font-bold ">
